...
```javascript
import { assert, ops, special, tools, utils } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base@v0.1.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base@v0.1.0-deno/mod.js';
