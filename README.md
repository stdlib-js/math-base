...
```javascript
import { assert, ops, special, tools, utils } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base@v0.2.0-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base@v0.2.0-esm/index.mjs';
